		...
		result += '<table class="hovertable" cellpadding="10" cellspacing="5">';
            ...
            for (var index in dummy) {
				...
				if (dummy[index][iok][bb].split('|')[0] == "true") {
                                    result += '<td class="clean"><font color="green">'+
									'<a href="screenshots/'+sanitizeFilename(index)+
									sanitizeFilename(bb).replace('-','')+'.png'+
									'" style="color:090;text-decoration: underline">'+
									'PASS'+
									'</a>'+
									'</font></td>';
                                }
                                if (dummy[index][iok][bb].split('|')[0] == "false") {
                                    result += '<td class="clean"><font color="red">'+
									'<a href="screenshots/'+sanitizeFilename(index)+
									sanitizeFilename(bb).replace('-','')+'.png'+
									'" style="color:900;text-decoration: underline">'+
									'FAIL'+
									'</a>'+
									'</font></td>';
                                }
